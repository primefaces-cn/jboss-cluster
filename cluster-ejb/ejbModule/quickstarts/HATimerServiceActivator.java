	...
	public void activate(ServiceActivatorContext context) {
		...
		try {
			...
			SingletonService<String> singleton = new SingletonService<String>(
					service, HATimerService.SINGLETON_SERVICE_NAME);
			/*
			 * We can pass a chain of election policies to the singleton, for
			 * example to tell JGroups to prefer running the singleton on a node
			...
			log.info("---------HATimerService will be installed finished-------!");
		} catch (Exception e) {
			log.error("---------HATimerService installed error-------");
			e.printStackTrace();
		}
	}
}
