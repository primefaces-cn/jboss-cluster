...
/**
 * A simple example to demonstrate a implementation of a cluster-wide singleton
 * timer.
 * 
...
public class SchedulerBean implements Scheduler {
	...
	public void initialize(String info) {
		...
		// persistent must be false because the timer is started by the
		// HASingleton service
	...
	@Override
	public void update(String t,ScheduleExpression se) {
		stop(t);
		timerService.createCalendarTimer(se, new TimerConfig(t, false));
	}
}
